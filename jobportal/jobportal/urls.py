...
urlpatterns = [
    ...
    path('delete_user/<int:pid>/', views.delete_users, name='delete_user'),
    ...
    path('apply_for_job/<int:pid>/', views.apply_for_job, name='apply_for_job'),
    ...
    path('delete_job_admin/<int:pid>/', views.delete_job_admin, name='delete_job_admin'),
    path('admin_view_applications/', views.admin_view_applications, name='admin_view_applications'),
    path('delete_application_admin/<int:pid>/', views.delete_application_admin, name='delete_application_admin'),
